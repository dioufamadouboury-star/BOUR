...
export default function WhatsAppButton() {
  ...
  return (
    <>
      ...
      {/* Floating WhatsApp Button - Smaller on mobile, positioned to not cover products */}
      <motion.button
        onClick={() => setIsOpen(!isOpen)}
        className="fixed bottom-4 right-2 md:right-6 z-50 w-12 h-12 md:w-14 md:h-14 bg-[#25D366] text-white rounded-full shadow-lg flex items-center justify-center hover:bg-[#20BA5A] transition-colors"
      ...
      >
        ...
        {/* Pulse animation when closed - less intrusive */}
        {!isOpen && (
