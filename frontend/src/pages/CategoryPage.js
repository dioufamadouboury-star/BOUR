...
const CATEGORY_HERO = {
  electronique: {
    ...
    filters: [
      ...
      { id: "Ordinateurs & PC", label: "Ordinateurs", icon: Cpu },
      { id: "Tablettes", label: "Tablettes", icon: Cpu },
      { id: "Audio & Casques", label: "Audio", icon: Watch },
      { id: "Gaming & Consoles", label: "Gaming", icon: Cpu },
      { id: "Accessoires téléphone", label: "Accessoires", icon: Watch },
